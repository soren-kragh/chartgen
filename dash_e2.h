...
# out gaps between years in case equidistant years is desired. Use dash (-) for
# years with no data in order to get a connected line, or the data can just be
# omitted entirely as is also shown.
Series.Data:
